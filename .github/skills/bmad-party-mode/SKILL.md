...
- **`agent-team`** — stand the personas up as a persistent team who address each other directly when supported by the runtime. Load `references/mode-agent-team.md`.
